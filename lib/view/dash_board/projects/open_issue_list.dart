...
class OpenIssueList extends StatefulWidget {
  const OpenIssueList({Key? key}) : super(key: key);

  @override
  State<OpenIssueList> createState() => _OpenIssueListState();
}

class _OpenIssueListState extends State<OpenIssueList> {
    ...
    return
      BlocBuilder<LoginBloc, LoginState>(
          builder: (context, state) {
            ...
            List<PunchList?>? punchListDetails = state.openPunchList;
